      ...
      <nav className={sticky ? "sticky-nav" : ""}>
        <div className="navbar">
          ...
          <span>
            ...
            <a href="https://www.linkedin.com/company/decodecafe-community" target="_blank" rel="noopener noreferrer">
            <IconBrandLinkedin />
            </a>
            {/* mobile */}
